                ...
                <div>
                    ...
                    <ul class="mt-3">
                        ...
                        <NavLink :href="route('chat')"
                            v-if="$page.props.auth.user.rol_id === 2 || $page.props.auth.user.rol_id === 1">
                        ...
                        <!--  PRFIL EMPRESA -->
                        <NavLink :href="route('perfil-empresa')" v-if="$page.props.auth.user.rol_id === 3">
                            <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="isExactActive && 'bg-slate-900'">
                                <a class="block text-slate-200 truncate transition duration-150" :class="isExactActive
                                    ? 'hover:text-slate-200'
                                    : 'hover:text-white'
                                ...
                                <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0" :class="isExactActive && 'bg-slate-900'">
                                    <a class="block text-slate-200 truncate transition duration-150" :class="isExactActive
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                                Asocicaciones Contratadas</span>
                                        </div>
                                    </a>
                                </li>
                            </NavLink>
