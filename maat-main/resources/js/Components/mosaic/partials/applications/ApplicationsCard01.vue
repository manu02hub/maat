          ...
          <div class="flex items-center space-x-2 mb-4">
            ...
            <div class="flex space-x-1">
              <button>
                ...
                <svg class="w-4 h-4 fill-current" :class="Math.round(item.rating) > 0 ? 'text-amber-500' : 'text-slate-300'" viewBox="0 0 16 16">
                  <path d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z" />
                </svg>
              </button>
              <button>
                <span class="sr-only">2 stars</span>
                <svg class="w-4 h-4 fill-current" :class="Math.round(item.rating) > 1 ? 'text-amber-500' : 'text-slate-300'" viewBox="0 0 16 16">
                  <path d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z" />
                </svg>
              </button>
              <button>
                <span class="sr-only">3 stars</span>
                <svg class="w-4 h-4 fill-current" :class="Math.round(item.rating) > 2 ? 'text-amber-500' : 'text-slate-300'" viewBox="0 0 16 16">
                  <path d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z" />
                </svg>
              </button>
              <button>
                <span class="sr-only">4 stars</span>
                <svg class="w-4 h-4 fill-current" :class="Math.round(item.rating) > 3 ? 'text-amber-500' : 'text-slate-300'" viewBox="0 0 16 16">
                  <path d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z" />
                </svg>
              </button>
              <button>
                <span class="sr-only">5 stars</span>
                <svg class="w-4 h-4 fill-current" :class="Math.round(item.rating) > 4 ? 'text-amber-500' : 'text-slate-300'" viewBox="0 0 16 16">
                  <path d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z" />
                </svg>
              </button>
            </div>
            <!-- Rate -->
            <div class="inline-flex text-sm font-medium bg-amber-100 text-amber-600 rounded-full text-center px-2.5 py-0.5">{{item.rating}}</div>
          </div>
          <!-- Features list -->
