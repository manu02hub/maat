      ...
      <div class="grow flex flex-col p-5">
        ...
        <div class="grow">
          ...
          <div class="flex items-center space-x-2 mb-4">
            <div class="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2.5 py-0.5">{{item.deal}}</div>
            <div class="inline-flex text-sm font-medium text-slate-500 line-through">{{item.price}}</div>
          </div>
        </div>
        <!-- Card footer -->
        <div>
