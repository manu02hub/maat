<template>
    <div class="grow flex flex-col md:translate-x-0 transition-transform duration-300 ease-in-out w-full"
                                    ...
                                    <div class="bg-white p-4 border border-slate-200 rounded-sm shadow-sm">
                                        ...
                                        <div class="flex justify-between items-center">
                                            ...
                                            <div class="flex -space-x-3 -ml-0.5">
                                                ...
                                                <img class="rounded-full border-2 border-white box-content" src=""
