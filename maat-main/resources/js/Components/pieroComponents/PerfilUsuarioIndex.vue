<template>
    <div class="grow flex flex-col md:translate-x-0 transition-transform duration-300 ease-in-out" :class="profileSidebarOpen ? 'translate-x-1/3' : 'translate-x-0'">
      ...
      <div class="relative h-56 bg-slate-200">
        <img class="object-cover h-full w-full" src="https://definicion.de/wp-content/uploads/2019/07/perfil-de-usuario.png" width="979" height="220" alt="Profile background" />
        <!-- Close button -->
        <button
      ...
      <div class="relative px-4 sm:px-6 pb-8">
        ...
        <div class="-mt-16 mb-6 sm:mb-3">
          ...
          <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
            ...
            <div class="inline-flex -ml-1 -mt-1 mb-4 sm:mb-0">
              <img class="rounded-full border-4 border-white" src="https://definicion.de/wp-content/uploads/2019/07/perfil-de-usuario.png" width="128" height="128" alt="Avatar" />
            </div>
        ...
        <header class="text-center sm:text-left mb-6">
          ...
          <div class="inline-flex items-start mb-2">
            <h1 class="text-2xl text-slate-800 font-bold">{{ $page.props.auth.user.nombre }}</h1>
          ...
          <!-- Bio -->
          <div class="text-sm mb-3">Trabajador de la la entidad {{ $page.props.auth.user }}</div>
          <!-- Meta -->
          <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
            <div class="flex items-center">
              ...
              <span class="text-sm font-medium whitespace-nowrap text-slate-500 ml-2">Madrid, España</span>
            </div>
            <div class="flex items-center">
              <svg class="w-4 h-4 fill-current shrink-0 text-slate-400" viewBox="0 0 16 16">
                <path d="M11 0c1.3 0 2.6.5 3.5 1.5 1 .9 1.5 2.2 1.5 3.5 0 1.3-.5 2.6-1.4 3.5l-1.2 1.2c-.2.2-.5.3-.7.3-.2 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l1.1-1.2c.6-.5.9-1.3.9-2.1s-.3-1.6-.9-2.2C12 1.7 10 1.7 8.9 2.8L7.7 4c-.4.4-1 .4-1.4 0-.4-.4-.4-1 0-1.4l1.2-1.1C8.4.5 9.7 0 11 0ZM8.3 12c.4-.4 1-.5 1.4-.1.4.4.4 1 0 1.4l-1.2 1.2C7.6 15.5 6.3 16 5 16c-1.3 0-2.6-.5-3.5-1.5C.5 13.6 0 12.3 0 11c0-1.3.5-2.6 1.5-3.5l1.1-1.2c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4L2.9 8.9c-.6.5-.9 1.3-.9 2.1s.3 1.6.9 2.2c1.1 1.1 3.1 1.1 4.2 0L8.3 12Zm1.1-6.8c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-4.2 4.2c-.2.2-.5.3-.7.3-.2 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l4.2-4.2Z" />
              </svg>
              <a class="text-sm font-medium whitespace-nowrap text-indigo-500 hover:text-indigo-600 ml-2" href="#0">{{ $page.props.auth.user.email }}</a>
            </div>
          </div>
        </header>
        ...
        <div class="flex flex-col xl:flex-row xl:space-x-16">
          ...
          <div class="space-y-5 mb-8 xl:mb-0">
            ...
            <!-- About Me -->
            <div>
              <h2 class="text-slate-800 font-semibold mb-2">Acerca de mi</h2>
            ...
            <!-- Work History -->
            <div>
              <h2 class="text-slate-800 font-semibold mb-2">Historial de eventos</h2>
          ...
          <aside class="xl:min-w-56 xl:w-56 space-y-3">
            <div class="text-sm">
              <h3 class="font-medium text-slate-800">Cargo</h3>
              <div>Senior Product Designer</div>
            </div>
            <div class="text-sm">
              <h3 class="font-medium text-slate-800">Localidad</h3>
