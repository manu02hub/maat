        ...
        <div class="div-header">
            <header>
                ...
                <div class="action-buttons">
                    <Link :href="route('createLikes')" class="action-añadir">
                    <button>Añadir likes</button>
                    </Link>
                </div>
            </header>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="attr-th">isLiked</th>

                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="likes in $page.props.like" :key="likes.id">
                            <td class="th-id">1</td>
                            <td class="attr-input-checkbox">
                                <input type="checkbox">
                            </td>
                            <td class="attr-td">{{ likes.user_id }}</td>
                            <td class="attr-td">{{ likes.post_id }}</td>
                            <td class="attr-td">{{ likes.isLiked }}</td>

                            <td class="attr-td">
                                <Link :href="route('editLikes', likes.id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                                ...
                                <Link :href="route('deleteLikes', likes.id)">
