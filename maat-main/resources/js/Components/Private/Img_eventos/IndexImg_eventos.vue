...
<template>
    <div class="grid-system">
        <div class="div-header">
            <header>
                <span class="img_eventos">img_eventos</span>
                <div class="action-buttons">
                    <Link :href="route('createImg_eventos')" class="action-añadir">
                    <button>Añadir img_eventos</button>
                    </Link>
                </div>
            </header>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="attr-th">ruta</th>
                            <th class="attr-th">evento_id</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="img_eventos in $page.props.img_evento" :key="img_eventos.id">
                            <td class="th-id">1</td>
                            <td class="attr-input-checkbox">
                                <input type="checkbox">
                            </td>
                            <td class="attr-td">{{ img_eventos.ruta }}</td>
                            <td class="attr-td">{{ img_eventos.evento_id }}</td>

                            <td class="attr-td">
                                <Link :href="route('editImg_eventos', img_eventos.id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                                ...
                                <Link :href="route('deleteImg_eventos', img_eventos.id)">
