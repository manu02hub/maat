...
<template>
    <div class="grid-system">
        <div class="div-header">
            <header>
                <span class="Matchs">Matchs</span>
                <div class="action-buttons">
                    <Link :href="route('createMatchs')" class="action-añadir">
                    <button>Añadir Matchs</button>
                    </Link>
                </div>
            </header>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="attr-th">post_empresa_id</th>
                            <th class="attr-th">organizacion_id</th>

                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="matchs in $page.props.match" :key="matchs.id">
                            <td class="th-id">1</td>
                            <td class="attr-input-checkbox">
                                <input type="checkbox">
                            </td>
                            <td class="attr-td">{{ matchs.post_empresa_id }}</td>
                            <td class="attr-td">{{ matchs.organizacion_id }}</td>

                            <td class="attr-td">
                                <Link :href="route('editMatchs', matchs.id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                                ...
                                <Link :href="route('deleteMatchs', matchs.id)">
