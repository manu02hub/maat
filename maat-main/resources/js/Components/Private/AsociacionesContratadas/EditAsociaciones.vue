...
const form = useForm({
    id: id,
    plan_contratado_id: plan_contratado_id,
    ...
    <div class="grid-system">
        <div>
            <div class="form-container">
                <form @submit.prevent="form.patch(route('updateAsocicacionesContratadas'))">
                    ...
                    <label for="plan_contratado_id">Plan_contratado_id:</label>
                    <input
                        type="text"
                        id="plan_contratado_id"
