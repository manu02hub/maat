    ...
    <div class="grid-system">
        <div>
            <div class="form-container">
                <form @submit.prevent="form.patch(route('storepersonalAccessToken'))">
                    <div class="title">Crear un PersonalAccessTokens</div>
                    ...
                    <div class="button-container">
                        <Link :href="route('indexpersonalAccessToken')" type="button" class="cancel-button">
                        Cancelar
                        </Link>
                        <PrimaryButton type="submit" class="submit-button" :class="{ 'opacity-25': form.processing }"
                            :disabled="form.processing">
                            Guardar PersonalAccessTokens
                        </PrimaryButton>
                    </div>
                </form>
            </div>
