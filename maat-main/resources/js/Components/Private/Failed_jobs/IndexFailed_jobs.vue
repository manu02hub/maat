...
<template>
    <div class="grid-system">
        <div class="div-header">
            <header>
                <span class="failed_jobs">failed_jobs</span>
                <div class="action-buttons">
                    <Link :href="route('createFailed_jobs')" class="action-añadir">
                    <button>Añadir failed_jobs</button>
                    </Link>
                </div>
            </header>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="attr-th">uuiid</th>
                            <th class="attr-th">queue</th>
                            <th class="attr-th">payload</th>
                            <th class="attr-th">exception</th>
                            <th class="attr-th">failed_at</th>
                            <th class="attr-th">Opciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="failed_jobs in $page.props.failed_job" :key="failed_jobs.id">
                            <td class="th-id">1</td>
                            ...
                            <td class="attr-td">{{ failed_jobs.failed_at }}</td>


                            <td class="attr-td">
                                <Link :href="route('editFailed_jobs', failed_jobs.id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                                ...
                                <Link :href="route('deleteFailed_jobs', failed_jobs.id)">
