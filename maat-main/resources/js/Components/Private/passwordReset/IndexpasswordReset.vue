...
<template>
    <div class="grid-system">
        <div class="div-header">
            <header>
                <span class="empresa">Password Resets</span>
                <div class="action-buttons">
                    <Link :href="route('createPasswordReset')" class="action-añadir">
                    <button>Añadir passwordReset</button>
                    </Link>
                </div>
            </header>
            ...
            <div class="div-tabla">
                <table>
                    ...
                    <tbody>
                        <tr v-for="passwordResets in $page.props.passwordReset" :key="passwordResets.id">
                            <td class="th-id">1</td>
                            <td class="attr-input-checkbox">
                                <input type="checkbox">
                            </td>
                            <td class="attr-td">{{ passwordResets.email }}</td>
                            <td class="attr-td">{{ passwordResets.token }}</td>
                            <td class="attr-td">
                                <Link :href="route('editPasswordReset', passwordResets.id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                                ...
                                <Link :href="route('deletePasswordReset', passwordResets.id)">
