...
<template>
    <div class="grid-system">
        <div class="div-header">
            <header>
                <span class="img_posts">img_posts</span>
                <div class="action-buttons">
                    <Link :href="route('createImg_post')" class="action-añadir">
                    <button>Añadir img_posts</button>
                    </Link>
                </div>
            </header>
            ...
            <div class="div-tabla">
                <table>
                    ...
                    <tbody>
                        <tr v-for="img_posts in $page.props.img_post" :key="img_posts.id">
                            <td class="th-id">1</td>
                            <td class="attr-input-checkbox">
                                <input type="checkbox">
                            </td>
                            <td class="attr-td">{{ img_posts.ruta }}</td>
                            <td class="attr-td">{{ img_posts.post_id }}</td>

                            <td class="attr-td">
                                <Link :href="route('editImg_post', img_posts.id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                                ...
                                <Link :href="route('deleteImg_post', img_posts.id)">
