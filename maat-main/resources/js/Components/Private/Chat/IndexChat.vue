...
<template>
    <div class="grid-system">
        <div class="div-header">
            <header>
                <span class="empresa">Chat</span>
                <div class="action-buttons">
                    <Link :href="route('createChat')" class="action-añadir">
                    <button>Añadir Chat</button>
                    </Link>
                </div>
            </header>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="attr-th">empresa_id</th>
                            <th class="attr-th">organizacion_id</th>
                            <th class="attr-th">Opciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="chats in $page.props.chat" :key="chats.id">
                            <td class="th-id">1</td>
                            <td class="attr-input-checkbox">
                                <input type="checkbox">
                            </td>
                            <td class="attr-td">{{ chats.empresa_id }}</td>
                            <td class="attr-td">{{ chats.organizacion_id }}</td>
                            <td class="attr-td">
                                <Link :href="route('editChat', chats.id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                                ...
                                <Link :href="route('deleteChat', chats.id)">
