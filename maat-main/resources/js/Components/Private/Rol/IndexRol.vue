...
<template>
    <div class="grid-system">
        <div class="div-header">
            <header>
                <span class="empresa">Roles</span>
                <div class="action-buttons">
                    <Link :href="route('createRol')" class="action-añadir">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="attr-th">Nombre del Rol</th>
                            <th class="attr-th">Opciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="rols in $page.props.rol" :key="rols.id">
                            <td class="th-id">1</td>
                            <td class="attr-input-checkbox">
                                <input type="checkbox">
                            </td>
                            <td class="attr-td">{{ rols.nombre }}</td>
                            <td class="attr-td">
                                <Link :href="route('editRol', rols.id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                                ...
                                <Link :href="route('deleteRol', rols.id)">
