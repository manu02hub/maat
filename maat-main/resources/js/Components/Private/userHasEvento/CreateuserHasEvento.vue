    ...
    <div class="grid-system">
        <div>
            <div class="form-container">
                <form @submit.prevent="form.patch(route('storeuserHasEvento'))">
                    <div class="title">Añadir userHasEvento</div>
                    ...
                    <div class="button-container">
                        <Link :href="route('indexuserHasEvento')" type="button" class="cancel-button">
                        Cancelar
                        </Link>
                        <PrimaryButton type="submit" class="submit-button" :class="{ 'opacity-25': form.processing }"
                            :disabled="form.processing">
                            Guardar userHasEvento
                        </PrimaryButton>
                    </div>
                </form>
            </div>
