...
<template>
    <div class="grid-system">
        <div class="div-header">
            <header>
                <span class="empresa">UserHasEvento</span>
                <div class="action-buttons">
                    <Link :href="route('createuserHasEvento')" class="action-añadir">
                    <button>Añadir UserHasEvento</button>
                    </Link>
                </div>
            </header>
            ...
            <div class="div-tabla">
                <table>
                    ...
                    <tbody>
                        <tr v-for="userHasEventos in $page.props.userHasEvento" :key="userHasEventos.user_id">
                            <td class="th-id">1</td>
                            <td class="attr-input-checkbox">
                                <input type="checkbox">
                            </td>
                            <td class="attr-td">{{ userHasEventos.user_id }}</td>
                            <td class="attr-td">{{ userHasEventos.evento_id }}</td>
                            <td class="attr-td">
                                <Link :href="route('edituserHasEvento', userHasEventos.user_id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                                ...
                                <Link :href="route('deleteuserHasEvento', userHasEventos.user_id)">
