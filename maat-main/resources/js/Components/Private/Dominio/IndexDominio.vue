...
<template>
    <div class="grid-system">
        <div class="div-header">
            <header>
                <span class="empresa">Dominio</span>
                <div class="action-buttons">
                    <Link :href="route('createDominio')" class="action-añadir">
            ...
            <div class="div-tabla">
                <table>
                    ...
                    <tbody>
                        <tr v-for="dominios in $page.props.dominio" :key="dominios.id">
                            <td class="th-id">1</td>
                            <td class="attr-input-checkbox">
                                <input type="checkbox">
                            </td>
                            <td class="attr-td">{{ dominios.nombre }}</td>
                            <td class="attr-td">{{ dominios.entidad_id }}</td>

                            <td class="attr-td">
                                <Link :href="route('editDominio', dominios.id)" class="text-slate-400 hover:text-slate-500 rounded-full">
                                ...
                                <Link :href="route('deleteDominio', dominios.id)">
