            ...
            <div class="flex flex-col xl:flex-row xl:space-x-16">
                ...
                <div class="space-y-5 mb-8 xl:mb-0">
                    ...
                    <div class="mb-2" v-if="$page.props.validator">
                        <ul class="inline-flex flex-wrap text-sm font-medium">
                            <li class="flex items-center">
                                <router-link
                                    class="text-slate-500 hover:text-emerald-500"
                                    to="/feed/index"
                                    >Eventos</router-link
                                >
                                <svg
                                    class="h-4 w-4 fill-current text-emerald-500 mx-2"
                                    viewBox="0 0 16 16"
                                >
                                    <path
                    ...
                    <div class="mt-4" v-if="$page.props.validator">
                        ...
                        <h3
                            class="font-semibold text-slate-800 mb-4 border-t-4 border-emerald-500"
                        >
                            Comentarios
                        </h3>
                        <ul
                            v-for="comentarios in $page.props.comentario"
                            class="space-y-5"
                        >
                            <!-- Comment -->
                            <li class="relative pl-9 space-y-5">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <!-- Comment text -->
                                        <div
                                            class="grow text-sm text-slate-800 space-y-2 mb-2"
                                        >
