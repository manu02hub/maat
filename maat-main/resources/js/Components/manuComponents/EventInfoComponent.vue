                ...
                <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <a class="text-sm font-medium whitespace-nowrap text-indigo-500 hover:text-indigo-600 ml-2"
                            href="#0">{{ $page.props.estaInscrito }} MAIL AQUI</a>
                    </div>
                </div>
            </header>
                ...
                <div class="space-y-5 mb-8 xl:mb-0">
                    ...
                    <header class="pb-4">
                        ...
                        <div class="flex items-start space-x-3 mb-3">
                            <h2 class="text-2xl text-slate-800 font-bold">{{ $page.props.posts.titulo }}</h2>
                        </div>
                        <!-- Meta -->
                        <div class="flex flex-wrap text-sm">
                            ...
                            <footer class="flex items-center space-x-4">
                                ...
                                <Link :href="route('añadirLike', $page.props.posts.id)">
                                <button class="flex items-center text-slate-400 hover:text-red-600">
                                    ...
                                    <div>
                                        <div>
                                            <div class="text-sm text-slate-500">{{ $page.props.likes }}</div>
                                        </div>
                                    </div>
                                </button>
                                </Link>
                    ...
                    <!-- Comment form -->
                    <div>
                        <form @submit.prevent="form2.patch(route('crearComentario', $page.props.posts.id))">
                            <div class="flex items-start space-x-3 mb-3">
